...
<html>
  <head>
	...
	<link href="css/index.css" type="text/css" rel="stylesheet">
	  ...
	  <script type="text/javascript" src="js/switchBorrows.js"></script>
  </head>
    ...
    <%@ include file="top.jsp" %>
  	<div id="main">
		...
		<div id="pageControl">
			...
			<div class="pageControl_item"><font id="currentPage">${currentPage }</font>/<font id="pages""pages">${pages }</font></div>
