...
<head>
    ...
    <script type=text/javascript"  src="js/test-clear.js" opacity= 0.6></script>
    <script type="text/javascript" src="js/switchBooks.js"></script>
</head>
...
<div id="main">
    <div class="navigation">
        当前位置:&nbsp;&nbsp;<a href="/book">首页</a>
        <div id="readerBlock">欢迎回来&nbsp;:<a href="/book?method=findAllBorrow&page=1">${sessionScope.reader.username }</a>&nbsp;<a href="/logout?type=reader">注销</a></div>
    </div>
    <div class="img_block">
    ...
    <table class="table" cellspacing="0">
        ...
        <c:forEach items="${list}" var="book">
            <tr>
                ...
                <td><a href="/book?method=deleteBook&id=${book.id}">删除</a></td>
                <td><a href="/book?method=modify&id=${book.id}">修改</a></td>
            </tr>
        </c:forEach>
    </table>

    <a href="/book?method=addBook">+</a>
